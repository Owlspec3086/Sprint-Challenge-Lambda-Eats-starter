...
Answer: useRouteMatch adds nested routes to an application that can change a single parameter in a URL without fully changing the whole thing.

2. How would you explain form validation to someone who has never programmed before?

Answer: When you submit a form to a program that resides on the server, it is usually programmed to do its own check for errors. If it finds any it sends the page back to the reader who then has to re-enter some data, before submitting again.

3. In 1-2 sentences, define end to end testing.

Answer: End to end test focuses on the user interface of how the application will function. This part is to check and make sure the user will have a smooth experience but you can see first on what happens before deployment. 
